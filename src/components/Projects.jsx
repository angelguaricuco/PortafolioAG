...
function Projects() {
  ...
  {/* Primary project */}
    ...
    {/* Second project */}
    <div className='projects_card'>
		<img src="../public/img/appclimas.png" alt="project 1" title="App Clima" className='img'/>
    ...
    {/* Third project */}
 <div className='projects_card'>
		<img src="../public/img/rickandmortys.png" alt="project 1" title="App Clima" className='img'/>
    ...
    {/* Fourth project*/}
    <div className='projects_card'>
		<img src="../public/img/fortunecookiee.png" alt="project 1" title="App Clima" className='img'/>
    ...
    <div className='projects_card'>
		<img src="../public/img/primerportafolioo.png" alt="project 1" title="App Clima" className='img'/>
